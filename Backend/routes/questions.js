...
const AnswerReply = require("../models/AnswerReply");
...
router.post("/reply-the-answer", async (req, res) => {
  try {
    //console.log(req.body);
    const reply = await AnswerReply.create(req.body);
    // console.log("body of appointment:", appointment);
...
router.get("/answers-of-particular-question/:questionId", async (req, res) => {
  try {
...
router.get("/replies-of-particular-answer/:answerId", async (req, res) => {
  try {
    const { answerId } = req.params;
    //console.log(req.body);
    const replies = await AnswerReply.find({ answerId });
    // console.log("body of appointment:", appointment);
...
router.get("/get-question-by-id/:questionId", async (req, res) => {
  try {
    const { questionId } = req.params;
    //console.log(req.body);
...
router.get("/get-my-questions/:userId", async (req, res) => {
  try {
